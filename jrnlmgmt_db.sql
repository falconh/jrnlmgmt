...
CREATE TABLE jrnlmgmt.STUDNT_TBL(
	STUDNT_ID VARCHAR(255) NOT NULL,
...
CREATE TABLE jrnlmgmt.SPRVISE_TBL(
	...
	SPRVISE_STDNT_ID VARCHAR(255) NOT NULL,
...
CREATE TABLE jrnlmgmt.JRNL_TBL(
    ...
    JRNL_QRTL_RANK VARCHAR(255),
    JRNL_IMPCT_FCTOR DECIMAL(10,4),
...
INSERT INTO jrnlmgmt.USR_TBL(USR_USRNM, USR_PASSWD, USR_NM, USR_DEPTMNT, USR_ROLE) VALUES('user@test.com','1234', 'Allen','Software Engineering','0');
INSERT INTO jrnlmgmt.USR_TBL(USR_USRNM, USR_PASSWD, USR_NM, USR_DEPTMNT, USR_ROLE) VALUES('admin@test.com','1234', 'Ken','Distributed Programming','1');